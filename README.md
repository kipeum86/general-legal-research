...
On-demand API fetches use the same `library/grade-a/` area. `open_law_api.py --save` and `eurlex_api.py --save` persist primary law materials there as Markdown or JSON so future sessions can reuse them locally.

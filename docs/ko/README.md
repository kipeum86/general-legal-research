...
## Jinju Legal Orchestrator 연계 에이전트

이 에이전트는 **Jinju Legal Orchestrator** 소속 스페셜리스트 법률 워크플로 에이전트 시리즈의 일부입니다.

| 에이전트 | 페르소나 | 전문 분야 |
|---------|----------|----------|
| [game-legal-research](https://github.com/kipeum86/game-legal-research) | 게임산업 스페셜리스트 심진주 | 게임 산업법 |
...
| [PIPA-expert](https://github.com/kipeum86/PIPA-expert) | 개인정보 스페셜리스트 정보호 | 개인정보보호법 |
| [GDPR-expert](https://github.com/kipeum86/GDPR-expert) | 개인정보 스페셜리스트 김덕배 | 데이터 보호법 (GDPR) |
